    ...
    >
      <DropdownTrigger>
        <Button
          ...
          className={`h-10 w-10 min-w-0 rounded-full border border-foreground/15 bg-background/70 p-0 shadow-sm backdrop-blur-md transition data-[hover=true]:border-primary/40 data-[hover=true]:bg-background/95 data-[hover=true]:shadow-md data-[focus-visible=true]:outline-none data-[focus-visible=true]:ring-2 data-[focus-visible=true]:ring-primary/30 ${
            isOpen
